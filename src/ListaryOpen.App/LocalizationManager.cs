...
internal static class LocalizationManager
{
    ...
    private static readonly IReadOnlyDictionary<string, string> SimplifiedChinese =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Preview source: Windows system"] = "预览来源：Windows 系统",
            ["Preview source: {0}"] = "预览来源：{0}",
            ["Built-in image"] = "内置图片",
            ["Built-in text"] = "内置文本",
            ["Built-in font"] = "内置字体",
            ["Windows thumbnail"] = "Windows 缩略图",
            ["Safe SVG"] = "安全 SVG",
            ["Archive summary"] = "压缩包摘要",
            ["Document text"] = "文档文本",
            ["Document summary"] = "文档摘要",
            ["EPUB text"] = "EPUB 文本",
            ["RTF text"] = "RTF 文本",
            ["PDF metadata"] = "PDF 元数据",
            ["Media metadata"] = "媒体元数据",
            ["Binary metadata"] = "二进制元数据",
            ["Match"] = "匹配",
            ["Usage"] = "使用频率",
            ["Name"] = "名称",
            ["Path"] = "路径",
